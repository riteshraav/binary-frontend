...
class BuffaloRatechartProvider with ChangeNotifier {
  ...
  // optional running totals you already use
  double morningBuffaloQuantity = 0.0;
  double eveningBuffaloQuantity = 0.0;

  static const _prefsKey = 'buffalo_ratechart_json_v1';
  ...
  void clearChart() async {
    ...
    _fatValues.clear();
    _rates.clear();
    _tableData.clear(); // <-- clear table data as well
    filePicked = false;
    final prefs = await SharedPreferences.getInstance();
