...
class RateGroupWindow extends ConsumerStatefulWidget {
  @override
  _RateGroupWindow createState() => _RateGroupWindow();
}


class _RateGroupWindow extends ConsumerState<RateGroupWindow> {
  final TextEditingController codeController = TextEditingController();
  final TextEditingController nameController = TextEditingController();
  late final rateGroupService;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      try {
        rateGroupService = ref.watch(rateGroupProvider);
        rates = await rateGroupService.listGroups();
        print('rates size is ${rates.length}');
        codeController.text = (rates.length + 1).toString();
  ...
  void _saveRateGroup() {
    print('save rate gour called');
    if (_formKey.currentState!.validate() ) {
   final rateGroup =    RateGroup(name: nameController.text.trim());
    rateGroupService.addGroup(rateGroup);
      setState(() {
        rates.add(rateGroup);
        _clearFields();
      });
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                                      ...
                                      Container(
                                        ...
                                        child:    RawKeyboardListener(
                                          ...
                                          child: TextFormField(
                                            ...
                                            validator: (value) {
                                              if (value == null || value.isEmpty) {
                                                return 'कृपया संघाचे नाव प्रविष्ट करा';
                                              }
                                              if (value.length < 3) {
                                                return 'संघाचे नाव किमान ३ अक्षरे असावे';
                                              }
                                              return null;
                                            },
                                            decoration: InputDecoration(
                                              ...
                                              hintText: 'संघाचे नाव प्रविष्ट करा',
                            ...
                            Row(
                              children: [
                                AnimatedSaveButton(focusNode: saveFocus, onPressed: _saveRateGroup),
                                SizedBox(width: 16),
                                Container(
                                  decoration: BoxDecoration(
                                    gradient: LinearGradient(
