...
extension SupplierQueryWhere on QueryBuilder<Supplier, Supplier, QWhereClause> {
  ...
  QueryBuilder<Supplier, Supplier, QAfterWhereClause> codeEqualTo(String code) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Supplier, Supplier, QAfterWhereClause> codeNotEqualTo(
      String code) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension SupplierQueryFilter
  ...
  QueryBuilder<Supplier, Supplier, QAfterFilterCondition> codeEqualTo(
    String value, {
  ...
  QueryBuilder<Supplier, Supplier, QAfterFilterCondition> codeGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Supplier, Supplier, QAfterFilterCondition> codeLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Supplier, Supplier, QAfterFilterCondition> codeBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Supplier, Supplier, QAfterFilterCondition> codeStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Supplier, Supplier, QAfterFilterCondition> codeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Supplier, Supplier, QAfterFilterCondition> codeContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Supplier, Supplier, QAfterFilterCondition> codeMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Supplier, Supplier, QAfterFilterCondition> codeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'code',
        value: '',
  ...
  QueryBuilder<Supplier, Supplier, QAfterFilterCondition> codeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'code',
        value: '',
...
extension SupplierQuerySortBy on QueryBuilder<Supplier, Supplier, QSortBy> {
  QueryBuilder<Supplier, Supplier, QAfterSortBy> sortByCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'code', Sort.asc);
    });
  }

  QueryBuilder<Supplier, Supplier, QAfterSortBy> sortByCodeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SupplierQuerySortThenBy
  ...
  QueryBuilder<Supplier, Supplier, QAfterSortBy> thenByCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'code', Sort.asc);
    });
  }

  QueryBuilder<Supplier, Supplier, QAfterSortBy> thenByCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'code', Sort.desc);
    });
  }
...
extension SupplierQueryWhereDistinct
  ...
  QueryBuilder<Supplier, Supplier, QDistinct> distinctByCode(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension SupplierQueryProperty
  ...
  QueryBuilder<Supplier, String, QQueryOperations> codeProperty() {
    return QueryBuilder.apply(this, (query) {
